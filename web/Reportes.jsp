...
<head>
    ...
    <title>Administracion - Fukusuke sushi</title>
...
<html>
    ...
    <body>
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Administracion FukusukeSushi</a>
                </div>
        ...
        <br></br>
        <div class="container">
            <div class="col-md-4 col-md-offset-4 panel panel-default panel-heading">
                <div class="">
                    <form action="reportes" method="POST" enctype="form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" class="btn btn-primary pull-right" name="enviar" value="Generar" />
                        </div>
                    </form>
                </div>
            </div>
            ...
            <tbody>
                <c:forEach var="item" items="${reporte}">
                    ...
                    <tr>
                        ...
                        <td>
                            <c:out value = "${item.detailQuantity}"/>
                        </td>
