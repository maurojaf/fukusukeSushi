...
--
-- Host: localhost    Database: sushifukusuke
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'sushifukusuke'
--
...
IN _comuna VARCHAR(50),
IN _provincia VARCHAR(80),
IN _region VARCHAR(100),
IN _fecha_nacimiento VARCHAR(15),
IN _sexo VARCHAR(10),
...
/*!50003 DROP PROCEDURE IF EXISTS `seleccionarProducts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2017-06-26 18:10:15
